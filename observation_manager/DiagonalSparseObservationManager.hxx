...
#ifndef VERDANDI_FILE_OBSERVATION_MANAGER_DIAGONALSPARSEOBSERVATIONMANAGER_HXX
...
namespace Verdandi
{
    ...
    /*! \brief Observation operator with an observation covariance matrix that
        is diagonal and stored in a sparse format.
    */
    /*!
      \tparam T the type of floating-point numbers.
    */
    template <class T>
    class DiagonalSparseObservationManager
    {
    protected:
...
#define VERDANDI_FILE_OBSERVATION_MANAGER_DIAGONALSPARSEOBSERVATIONMANAGER_HXX
#endif
